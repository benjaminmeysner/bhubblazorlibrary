...
namespace BHub.Lib.Interfaces
{
    ...
    /// <returns></returns>
    public delegate IQueryable<object> PagedQueryableCallBack(IQueryable<object> source);

    /// <summary>
    /// Wrapper class around <see cref="IQueryable{T}" /> splitting up the collection
    /// into paged sections. Calling the standard enumerator for this class returns the paged data.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <seealso cref="System.Collections.Generic.IPagedQueryable{T}" />
    public interface IPagedQueryable<T> : IQueryable<T>
    {
        ...
        /// <summary>
        /// Updates the source object with the new parameter <see cref="IQueryable{T}"/>
        /// </summary>
        ...
        /// The function takes in the source collection and expects the same type <see cref="IQueryable{T}"/> returned.
        /// </summary>
        /// <value>
